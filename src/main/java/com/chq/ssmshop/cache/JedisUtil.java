...
/**
 * JedisUtil封装了用Java对Redis的各种数据结构的操作
 * 
 * @author chq
 *
 */
public class JedisUtil {
	...
	/**
	 * 对存储结构为String类型的操作 String
	 * 在redis中是二进制安全的，这意味着jpeg,JSON等任何数据都可以转换为Redis中的String对象存储在Redis中
	 * Redis中的String最大容量是512M
	 */
